...
| 優先 | ハブ | 対象 | 条件 |
|---:|---|---|---|
| 1 | 課題別事例ハブ | 日報自動化、申請承認、顧客管理、ナレッジ共有、Excel脱却、AI活用 | 既存事例を整理して重複しない構造にできること |
| 2 | 業種別ハブ | 製造業、建設業、福祉/介護、飲食/小売 | 実績・事例・課題が十分にあること |
| 3 | 地域別ページ | 行田市、上尾市、伊奈町、桶川市 | 実績、相談、訪問可能性、地域文脈があること |
| 4 | MEO/AIOサービスLP | MEO、サイテーション、AI検索対策 | 主商材として打ち出す判断があること |
